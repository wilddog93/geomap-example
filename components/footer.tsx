...
function Footer() {
  return (
    <footer className="w-full bg-gradient-to-r from-green-500 to-blue-400 flex flex-col lg:flex-row items-center p-4 sticky bottom-0 z-10 justify-center lg:justify-end">
